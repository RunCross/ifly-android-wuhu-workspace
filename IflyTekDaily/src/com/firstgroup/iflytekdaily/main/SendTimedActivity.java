...
//					 aManager.set(AlarmManager.RTC_WAKEUP, setTime, pIntent);
					 ...
					 System.out.println("真实的时间：" + System.currentTimeMillis());
						System.out.println("设定的时间；" + setTime);
...
//					System.out.println("定时发送取消！");
	...
	private boolean isMyServiceRunning() {
	    ...
	    for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
	    	System.out.println("服务名："+service.service.getClassName());
	        if ("com.firstgroup.iflytekdaily.services.AutoSendServices".equals(service.service.getClassName())) {
	            return true;
	        }
	    }
	    return false;
