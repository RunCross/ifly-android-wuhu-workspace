...
public class RSACoder {
	...
	public static byte[] encryptByPrivateKey(String key,byte[] data) throws Exception{
		//实例化密钥材料
		PKCS8EncodedKeySpec pcs8spec=new PKCS8EncodedKeySpec(Base64.decode(key, Base64.DEFAULT));
		//实例化密钥工厂
	...
	public static byte[] decryptByPublicKey(String key,byte[] data) throws Exception{
		//实例化公钥材料
		X509EncodedKeySpec x509spec=new X509EncodedKeySpec(Base64.decode(key, Base64.DEFAULT));
		//实例化密钥工厂
		KeyFactory keyfactory=KeyFactory.getInstance(Key_ALGORITHM);
		//获得公钥
