...
import com.runcross.maback.Think;
...
import com.runcross.maback.data.Info.TimeoutEntry;
	...
	public void auto() throws Exception {
		try {
			if (ErrorData.currentErrorType != ErrorData.ErrorType.none) {
				...
				if (Info.nightModeSwitch && info.events.empty() && info.NoFairy) Thread.sleep(600000); // 鍗婂閫熷害鎱㈢偣
			}
		} catch (Exception ex) {
			throw ex;
		}
...
//			break;
		case NOTHING:
			Thread.sleep(30000); // 鏃犱簨鍙仛浼戞伅30绉�			break;
		default:
			break;
